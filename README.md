...
![SafePass Front Page](https://disznc.s3.amazonaws.com/Screen-Shot-2021-07-04-at-9.04.09-PM.png)
...
SafePass is an opensource application to communicate passwords over the web. Links to passwords expire after a certain number of views and/or time has passed.

Hosted at [pwpush.com](https://pwpush.com) but you can also easily run your own private instance with just a few steps.

Follow SafePass [on Twitter](https://twitter.com/pwpush) or [on Facebook](https://www.facebook.com/pwpush) for the latest news, updates and changes.

</div>

# How to Use

You can access SafePass at [pwpush.com](https://pwpush.com) or alternatively use one of the tools below.
...
See [this blog post](https://tamethe.cloud/pwpush-host-your-own-using-azure-containers/) on how to deploy SafePass to Azure by Craig McLaren.
...
_This option will deploy a production SafePass instance backed by a postgres database to Heroku.  As is monthly cost: $0._
